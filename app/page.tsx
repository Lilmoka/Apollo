...
export default function Home() {
  ...
  // ✅ الحل: helper function بتحل مشكلة TypeScript narrowing
      ...
      >
        <div
          style={{
            ...
            height: "60vw",
            background:
              "radial-gradient(circle, rgba(0, 102, 255, 0.4) 0%, rgba(0,0,0,0) 70%)",
            filter: "blur(80px)",
            borderRadius: "50%",
            zIndex: 1,
          }}
        ...
        <div
          style={{
            ...
            height: "50vw",
            background:
              "radial-gradient(circle, rgba(200, 200, 200, 0.1) 0%, rgba(0,0,0,0) 70%)",
            filter: "blur(100px)",
            borderRadius: "50%",
            zIndex: 1,
          }}
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `@keyframes pulseText { 0% { opacity: 0.9; transform: scale(0.98); } 100% { opacity: 1; transform: scale(1.02); } }`,
          }}
        />
      </div>
    );
  ...
  return (
    ...
    >
        ...
        <div className="hero-banner">
          ...
          <div className="top-bar">
            ...
            <div>
              ...
              <span className="text-gold" style={{ fontWeight: "bold" }}>
                EGP 1000
              </span>
            </div>
          </div>
          ...
          <nav className="nav-main">
            <h1
              ...
              style={{ fontSize: "32px", fontWeight: 900, cursor: "pointer", color: "#fff", letterSpacing: "2px" }}
            >
              APOLLO<span className="text-gold">.</span>
            </h1>
            {/* ✅ استخدام activeClass() بدل المقارنة المباشرة */}
            <div className="nav-links" style={{ display: "flex", gap: "40px" }}>
              ...
              <span className={`nav-link ${activeClass("about")}`} onClick={() => navigateToView("about")}>About</span>
            </div>
            <div style={{ display: "flex", gap: "25px", alignItems: "center", color: "#fff", cursor: "pointer" }}>
              <div
                onClick={() => navigateToView("checkout")}
                style={{ position: "relative", display: "flex", alignItems: "center", gap: "8px", fontWeight: "bold" }}
              >
                <span style={{ fontSize: "20px" }}>🛒</span> CART
                <span
                  style={{
                    position: "absolute", top: "-10px", right: "-15px",
                    background: "#d4af37", color: "#000", fontSize: "11px",
          ...
          <div
            style={{
              ...
              transform: "translate(-50%, -50%)", textAlign: "center", zIndex: 10, width: "100%",
            }}
          >
            <h2
              style={{
                fontSize: "clamp(30px, 5vw, 60px)", color: "#fff", fontWeight: 900,
      ...
      {currentView !== "home" && (
        <>
          <div className="top-bar" style={{ background: "rgba(0,0,0,0.8)", backdropFilter: "blur(10px)" }}>
            ...
            <div>
              Free delivery on order over{" "}
              <span className="text-gold" style={{ fontWeight: "bold" }}>EGP 1000</span>
            </div>
          </div>
          <nav
            className="nav-main"
            style={{
              ...
              borderBottom: "1px solid rgba(0,0,0,0.1)", position: "sticky", top: 0,
            }}
          >
            <h1
              onClick={() => navigateToView("home")}
              style={{ fontSize: "32px", fontWeight: 900, cursor: "pointer", color: "#001a33", letterSpacing: "2px" }}
            >
              APOLLO<span className="text-gold">.</span>
            </h1>
            {/* ✅ استخدام activeClass() هنا كمان */}
            <div className="nav-links" style={{ display: "flex", gap: "40px" }}>
              ...
              <span className={`nav-link ${activeClass("about")}`} style={{ color: "#333" }} onClick={() => navigateToView("about")}>About</span>
            </div>
            <div style={{ display: "flex", gap: "25px", alignItems: "center", color: "#001a33", cursor: "pointer" }}>
              ...
              >
                ...
                <span
                  style={{
                    position: "absolute", top: "-10px", right: "-15px",
                    background: "#001a33", color: "#fff", fontSize: "11px",
                    width: "20px", height: "20px", borderRadius: "50%",
                    display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "900",
                  }}
                >
      ...
      {currentView === "shop" && (
        <div className="fade-in">
          <div className="section-header">
            <h2 style={{ color: "#fff", textShadow: "0 0 20px rgba(0,0,0,0.8)" }}>
              Our <span className="text-gold">Collection</span>
            </h2>
            <p style={{ color: "#f0f0f0", textShadow: "0 0 10px rgba(0,0,0,0.8)" }}>
              Browse through {products.length} exclusive items.
            </p>
          </div>
      ...
      {currentView === "about" && (
        <div
          className="fade-in"
          style={{ padding: "80px 40px", textAlign: "center", minHeight: "50vh", position: "relative", zIndex: 2 }}
        >
          <h2
            style={{
              fontSize: "50px", fontWeight: 900, textTransform: "uppercase",
              marginBottom: "30px", color: "#fff", textShadow: "0 0 20px rgba(0,0,0,0.8)",
            }}
          >
          ...
          <div
            style={{
              background: "rgba(255,255,255,0.85)", backdropFilter: "blur(10px)",
              padding: "40px", borderRadius: "12px", maxWidth: "700px",
              margin: "0 auto", boxShadow: "0 10px 30px rgba(0,0,0,0.1)",
            }}
          >
            <p style={{ fontSize: "16px", color: "#333", lineHeight: "1.8", fontWeight: "bold" }}>
              APOLLO creates premium accessories, signature fragrances, bags, and modern eyewear
              with bold silhouettes, architectural minimalism, and editorial luxury inspiration
      ...
      {currentView === "checkout" && (
        <div
          className="fade-in"
          style={{ padding: "60px 20px", maxWidth: "900px", margin: "0 auto", minHeight: "60vh", position: "relative", zIndex: 2 }}
        >
          <h2
            style={{
              fontSize: "40px", fontWeight: 900, textAlign: "left", marginBottom: "30px",
              textTransform: "uppercase", color: "#fff", textShadow: "0 0 20px rgba(0,0,0,0.8)",
            }}
          >
          ...
          {cart.length === 0 ? (
            ...
            >
              <p style={{ fontSize: "20px", color: "#001a33", marginBottom: "20px", fontWeight: "bold" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "99px", fontWeight: "bold", cursor: "pointer",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px" }}>
              <div
                style={{
                  ...
                  borderRadius: "12px", padding: "30px", boxShadow: "0 10px 30px rgba(0,0,0,0.1)",
                }}
              >
                {cart.map((item, index) => (
                  <div
                  ...
                  >
                    <div
                      style={{
                        ...
                        marginRight: "20px", borderRadius: "8px", border: "1px solid #eaeaea",
                      }}
                    >
                      <img
                        src={item.image}
                    ...
                    <div style={{ flex: 1 }}>
                      <p style={{ fontWeight: "800", fontSize: "18px", color: "#001a33", marginBottom: "5px", textTransform: "uppercase" }}>
                        {item.name}
                      </p>
                      <p className="text-gold" style={{ fontSize: "16px", fontWeight: "900" }}>
                        EGP {item.price}
                      </p>
                    </div>
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer", fontWeight: "bold", fontSize: "14px", textDecoration: "underline",
                      }}
                    >
                      Remove
                    </button>
              ...
              <div
                style={{
                  ...
                  padding: "40px", borderRadius: "12px", boxShadow: "0 10px 30px rgba(0,0,0,0.1)",
                }}
              >
                <p style={{ fontSize: "28px", fontWeight: "900", color: "#001a33", marginBottom: "30px" }}>
                  Total: <span className="text-gold">EGP {total}</span>
                </p>
                ...
                <button
                  style={{
                    ...
                    padding: "18px 50px", borderRadius: "99px", fontSize: "16px",
                    fontWeight: "900", cursor: "pointer", textTransform: "uppercase",
                    letterSpacing: "2px", boxShadow: "0 5px 15px rgba(212, 175, 55, 0.4)",
                  }}
                >
                  PROCEED TO CHECKOUT
                </button>
